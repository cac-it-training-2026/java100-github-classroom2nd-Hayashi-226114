...
class Robot {
	...
	void makeOmlet(int eggNum, int butterNum) {
		int omletNum1 = eggNum / 2;
		int omletNum2 = butterNum / 5;

		if (omletNum1 > omletNum2) {
			System.out.println(omletNum2 + "人分のオムレツを作成しました。");
		} else {
			System.out.println(omletNum1 + "人分のオムレツを作成しました。");
